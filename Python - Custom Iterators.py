...
# 1. ---    __iter__()    --- Each iterator class should have the __iter__() method. It is the initialization of an iterator (Just like we use __init__() to initializa a class). It returns an iterator object
...
class Data:
    ...
    def __iter__(self):                 # Step 2
        self.value = 10                                     # __iter__ method returns the iterator object
        return self
