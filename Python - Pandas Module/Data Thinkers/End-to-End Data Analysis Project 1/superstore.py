...
pd.set_option("display.float_format", lambda x: "%.3f"%x)   #To show the values in floating point value rather than the exponential format

#https://www.youtube.com/watch?v=wOrVI4oeMzw&list=PL_1pt6K-CLoDMEbYy2PcZuITWEjqMfyoA&index=21&t=811s
