...
# Third party module is known as packages
# A collection of related modules and packages is called library


# Three ways to import a module :
        # 1. Using the import statement - Imports the whole module in our code, -- import module_name --
        # 2. Using the 'as' keyword - Importing and renaming the module with an alias --  import module_name as m  -- here 'm' is a shorter version of the module name, 
        # 3. Using the from_import statement  - In situation where we just need some particular funcion/class/variable from a module,  -- from module_name import function_name --
...
import math             #That's how you import a built-in module
...
print(os.name)          # here the -- name -- is not a function rather a variable/attribute inside os module
...
# PIP is the package manager of python, which helps us to install third party packages
...
# Custom modules are simple python file that can be imported into another file, and created by you according to your own needs
