...
# 1/a np.reciprocal(a)
#=============================================================================================
# Minimum Value np.min(a)           # Maximum Value np.max(a)       # Postion of Minimum Value np.argmin(a, axis=)           - Here argmin is Arguments of min      N.B: Min, Max - For multidimensional array you have to pass axis(0 or 1 etc.) to find the minimum/maximum element of column or rows
# Cosine  np.cos(a)                 # Sine      np.sin(a)           #Postion of Maximum Value  np.argmax(a, axis=)           - Here argmax is Arguments of max    
# Cumulative Sum  np.cumsum(a)      # Square Root   np.sqrt(a)
#===============================================================================================



#Addition - with constant values and with other arrays - only the arrays of the same shapes (also same dimension) can be added together with other arrays
                    # Constant value doesn't have to be of same shape
list1 = [1, 2, 3, 4]
arr1 = np.array(list1)
