...
transpose_matrix2 = matrix1.T       # Here -- T -- is a variable name of the np.matrix class that's why we didn't use -- () -- at the end
...
# === Power of Matrix ===
                ...
                # For n<0 , the power is applied on the inverse of that matrix i.e. (A^(-1*n))          #which is a common simple mathematics
