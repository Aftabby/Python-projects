...
#When you run a program -- black file_name.py  -- in the command line, the program file gets reformatted with spaces or new line to match a sophisticated and consistent style
...
# That's why we use the keyword -- yield -- as it returns the value from a function to the main or caller function, part by part (not taking too much memory at a time), 
