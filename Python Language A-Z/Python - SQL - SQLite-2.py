...
if user_email in all_email[0]:
    ...
    user_password = input("You are not an user. To be a new user, please register with a new password: ")
...
#cursor.execute("SELECT DISTINCT City FROM Friends")         #Suppose you have a table named -- Friends -- and all friends has a city column
                                                            ...
                                                            #This code will give use an error as we do not have a table named -- Friends -- and no column in it named -- City --
