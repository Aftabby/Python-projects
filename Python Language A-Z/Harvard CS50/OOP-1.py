class Student:
    ...
    def __str__(self):  #A special kind of method that is automatically called while the object (that is made from the class) is accessed from outside, like -- print(object_name) -- 
...
def main():
    ...
    #WE can change the attribute by accessing the object variable ( --  _house  --) from here, but it actually triggering a method -- house -- from @house.setter -- the actual object variable is --  _house  ---
